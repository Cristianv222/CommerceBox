...
from .printers.printer_service import PrinterService, TicketPrinter, LabelPrinter
...
class HardwareDashboardView(InventarioAccessMixin, TemplateView):
...
class ImpresoraListView(InventarioAccessMixin, ListView):
    """Lista de impresoras"""
    model = Impresora
...
class ImpresoraCreateView(InventarioEditMixin, CreateView):
...
class ImpresoraDetailView(InventarioAccessMixin, DetailView):
...
class ImpresoraUpdateView(InventarioEditMixin, UpdateView):
    """Editar impresora"""
    model = Impresora
    form_class = ImpresoraForm
    template_name = 'hardware/impresora_form.html'
...
class ImpresoraDeleteView(InventarioDeleteMixin, DeleteView):
    """Eliminar impresora"""
    model = Impresora
...
class TestConexionView(InventarioEditMixin, View):
...
class TestPaginaPruebaView(InventarioEditMixin, View):
...
class MantenimientoImpresoraView(InventarioEditMixin, View):
...
class PlantillaListView(InventarioAccessMixin, ListView):
...
class PlantillaCreateView(InventarioEditMixin, CreateView):
...
class PlantillaDetailView(InventarioAccessMixin, DetailView):
...
class PlantillaUpdateView(InventarioEditMixin, UpdateView):
    """Editar plantilla"""
    model = PlantillaImpresion
    form_class = PlantillaImpresionForm
    template_name = 'hardware/plantilla_form.html'
...
class PlantillaDeleteView(InventarioDeleteMixin, DeleteView):
    """Eliminar plantilla"""
    model = PlantillaImpresion
...
class ConfigCodigoBarrasListView(InventarioAccessMixin, ListView):
...
class ConfigCodigoBarrasCreateView(InventarioEditMixin, CreateView):
...
class ConfigCodigoBarrasDetailView(InventarioAccessMixin, DetailView):
...
class ConfigCodigoBarrasUpdateView(InventarioEditMixin, UpdateView):
...
class GavetaDineroListView(InventarioAccessMixin, ListView):
...
class GavetaDineroCreateView(InventarioEditMixin, CreateView):
...
class GavetaDineroDetailView(InventarioAccessMixin, DetailView):
    """Detalle de gaveta"""
    model = GavetaDinero
...
class GavetaDineroUpdateView(InventarioEditMixin, UpdateView):
    """Editar gaveta"""
    model = GavetaDinero
    form_class = GavetaDineroForm
    template_name = 'hardware/gaveta_form.html'
...
class AbrirGavetaView(InventarioEditMixin, View):
...
class EscanerListView(InventarioAccessMixin, ListView):
    """Lista de escáneres"""
...
class EscanerCreateView(InventarioEditMixin, CreateView):
    """Crear escáner"""
    model = EscanerCodigoBarras
...
class EscanerDetailView(InventarioAccessMixin, DetailView):
    """Detalle de escáner"""
    model = EscanerCodigoBarras
...
class EscanerUpdateView(InventarioEditMixin, UpdateView):
    """Editar escáner"""
    model = EscanerCodigoBarras
    form_class = EscanerCodigoBarrasForm
    template_name = 'hardware/escaner_form.html'
...
class RegistroImpresionListView(InventarioAccessMixin, ListView):
