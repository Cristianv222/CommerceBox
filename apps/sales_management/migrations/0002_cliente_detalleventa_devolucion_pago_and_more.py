# Generated by Django 4.2.7 on 2025-09-30 22:13
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.TextField(
                blank=True, help_text="XML de la factura electrónica"
            ),
        ),
        migrations.AddField(
            model_name="venta",
        ...
        migrations.AddField(
            ...
            field=models.DateTimeField(
                ...
                default=datetime.datetime(
                    2025, 9, 30, 22, 12, 55, 732935, tzinfo=datetime.timezone.utc
                ),
            ),
        ...
        migrations.AddField(
            ...
            field=models.DateField(
                blank=True, help_text="Fecha de vencimiento si es crédito", null=True
            ),
        ),
        migrations.AddField(
            model_name="venta",
        ...
        # AGREGAR CLIENTE ANTES DE LOS INDICES
        migrations.AddField(
            model_name="venta",
            name="cliente",
            field=models.ForeignKey(
        ...
        # AHORA SI CREAR LOS INDICES
        migrations.AddIndex(
            model_name="venta",
            index=models.Index(
                fields=["numero_venta"], name="sales_venta_numero__c2f714_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="venta",
            index=models.Index(
                fields=["numero_factura"], name="sales_venta_numero__a2be34_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="venta",
            index=models.Index(
                fields=["-fecha_venta", "estado"], name="sales_venta_fecha_v_bb2a8c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="venta",
            index=models.Index(
                ...
                name="sales_venta_cliente_93fb7d_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="venta",
            index=models.Index(
                fields=["vendedor", "-fecha_venta"],
                name="sales_venta_vendedo_1522de_idx",
            ),
        ),
        migrations.AddField(
            model_name="pago",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.PROTECT,
                to="sales_management.detalleventa",
            ),
        ),
        migrations.AddField(
            model_name="devolucion",
        ...
        migrations.AddIndex(
            model_name="cliente",
            index=models.Index(
                fields=["numero_documento"], name="sales_clien_numero__98b8fc_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="cliente",
            index=models.Index(
                fields=["tipo_cliente", "activo"], name="sales_clien_tipo_cl_92f8f1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="detalleventa",
            index=models.Index(
                fields=["venta", "orden"], name="sales_detal_venta_i_a69060_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="detalleventa",
            index=models.Index(
                fields=["producto"], name="sales_detal_product_7caff0_idx"
            ),
        ),
    ]