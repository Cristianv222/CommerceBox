...
class CertificadoDigital(models.Model):
    ...
    nombre_titular = models.CharField(max_length=300, null=True, blank=True, editable=True)
    ruc_titular = models.CharField(max_length=13, null=True, blank=True, editable=True)
    emisor = models.CharField(max_length=300, null=True, blank=True, editable=True)
    ...
    def _get_cipher(self):
        ...
        # Esto elimina la necesidad de configurar SRI_ENCRYPTION_KEY en el .env
...
class ComprobanteElectronico(models.Model):
    ...
    def __str__(self):
        return f"{self.tipo_comprobante} - {self.venta.numero_venta} ({self.estado})"
